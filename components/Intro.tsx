...
const Intro = () => {
  return (
    <section className="bg-zinc-200/40">
      <div className="container flex flex-col items-center gap-16 xl:flex-row">
        <div className="content space-y-4 flex-1">
          <FeaturedText>
            Amigos Venture Capital is a boutique investment firm that
            specializes in seed capital for the telecom sector. We combine
            industry expertise with passion and personal networks to support the
            entrepreneurs we partner with.
          </FeaturedText>
          <p>
            Headquartered in Dubai, Stockholm and Lusaka, we are supporting
            telcos and fin-tech worldwide. The founders and partners have a long
